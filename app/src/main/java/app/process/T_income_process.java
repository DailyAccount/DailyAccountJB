...
import app.dababase.T_income_helper;

public class T_income_process {
    private static T_income_helper database;
    private Context context;

    public T_income_process(Context context) {
        this.context = context;
        database = new T_income_helper(context);
    }

    public void save(T_income_account account) {
    ...
    public T_income_account find(Integer id) {
        SQLiteDatabase db = database.getReadableDatabase();
